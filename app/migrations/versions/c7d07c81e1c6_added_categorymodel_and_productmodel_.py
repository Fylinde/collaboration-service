...
def upgrade() -> None:
    ...
    op.add_column(
        "collaborations",
        sa.Column("collaboration_type", sa.String(length=10), nullable=False),
    )
    op.add_column(
        "collaborations", sa.Column("product_id", sa.Integer(), nullable=True)
    )
    op.add_column(
        "collaborations", sa.Column("category_id", sa.Integer(), nullable=True)
    )
    op.add_column(
        "collaborations",
        sa.Column("geographical_exclusivity", sa.Boolean(), nullable=True),
    )
    op.add_column(
        "collaborations", sa.Column("bulk_order_threshold", sa.Integer(), nullable=True)
    )
    op.add_column(
        "collaborations",
    ...
    op.add_column(
        "collaborations", sa.Column("contract_terms", sa.Text(), nullable=True)
    )
    op.add_column(
        "collaborations",
        sa.Column("collaboration_start_date", sa.DateTime(), nullable=True),
    )
    op.add_column(
        "collaborations",
        sa.Column("collaboration_end_date", sa.DateTime(), nullable=True),
    )
    op.add_column(
        "collaborations", sa.Column("updated_at", sa.DateTime(), nullable=True)
    )
    op.alter_column(
        "collaborations", "seller_id", existing_type=sa.INTEGER(), nullable=False
    )
    op.alter_column(
        "collaborations",
        "partner_seller_id",
    ...
    op.add_column(
        "sellers", sa.Column("phoneNumber", sa.String(length=20), nullable=True)
    )
    op.add_column(
        "sellers", sa.Column("business_license", sa.String(length=100), nullable=True)
    )
    op.add_column("sellers", sa.Column("address", sa.String(length=255), nullable=True))
    op.add_column(
        "sellers", sa.Column("warehouse_location", sa.String(length=255), nullable=True)
    )
    op.add_column(
        "sellers",
        sa.Column("preferred_collaboration_types", sa.String(length=50), nullable=True),
    )
...
def downgrade() -> None:
    ...
    op.drop_column("sellers", "phoneNumber")
    ...
    op.alter_column(
        "collaborations", "partner_seller_id", existing_type=sa.INTEGER(), nullable=True
    )
    op.alter_column(
        "collaborations", "seller_id", existing_type=sa.INTEGER(), nullable=True
    )
